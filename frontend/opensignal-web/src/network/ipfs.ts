...
const saveOnIPFSWithWeb3Storage = async (properties: any, avatar?: any) => {
    const token =
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweDZCZWIzQmQ4MjQyODVCNDlDODNjZEQxMjkyQTdGNmQ5ZWNFNDRkOUMiLCJpc3MiOiJ3ZWIzLXN0b3JhZ2UiLCJpYXQiOjE2MzI0MTYzMDYxMTAsIm5hbWUiOiJPcGVuU2lnbmFsIn0.COZtw1xHp_26UU_rkv0VLaWMhUxiCbVI3llqTqnajEs";
