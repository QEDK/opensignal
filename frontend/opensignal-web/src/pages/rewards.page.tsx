...
const RewardsPage = () => {
    ...
    async function getRewardContractAddress() {
        ...
        await openSignalContract.methods["0x0c7d5cd8"].then(console.log).catch(console.log);
    }
    return (
...
const ProjectCard = ({ project }: { project: Project }) => {
    ...
    async function getRewardContractAddress() {
        console.log(openSignalContract, "oss");
        await openSignalContract.methods.rewardsDistribution().then(console.log).catch(console.log);
    }
    return (
        <div className="project">
            <button onClick={getRewardContractAddress}>get Reward Contract</button>
