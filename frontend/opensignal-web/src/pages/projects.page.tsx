    ...
    <div className="project">
      <div className="project-avatar">
        {projectMetaLoading ? (
          ...
          <img object-fit="cover" src={projectMeta?.avatar ? projectMeta.avatar : project.avatar} />
        )}
      ...
      <Modal.Content>
        <Modal.Description>
          ...
          <Input
            ...
            onChange={(e) =>
              setAmount(
                e.target.value == "" || (re.test(e.target.value) && Number(e.target.value) < 1e15)
            ...
            label={
              <button
                ...
                onClick={() => setAmount(state.tokenBalance < 0 ? amount : state.tokenBalance)}
              >
                <p>MAX</p>
                <div>
...
const RmoveSignalModal = ({
  ...
  const [totalSupply, totalSupplyLoading, totalSupplyErr] = useGetTotalSupply(project?.deployment);
    ...
    >
      ...
      <Modal.Content>
        <Modal.Description>
          ...
          <Header>
            {shareBalanceLoading ? <Loader size="mini" active /> : `Your stake: ${shareBalance}`}
          </Header>
          ...
          <Input
            ...
            label={
              ...
              >
                <p>MAX</p>
                <div>{shareBalanceLoading ? <Loader size="mini" active /> : `${shareBalance}`}</div>
              </button>
            }
            labelPosition="right"
          />
